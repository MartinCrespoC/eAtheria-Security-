...
async function main() {
  const code = fs.readFileSync("vendor/fp/owasp-benchmark/src/main/java/org/owasp/benchmark/testcode/BenchmarkTest01440.java", "utf-8");
  ...
  const findings = runTaintAnalysis(code, "BenchmarkTest01440.java", "java", rules);
